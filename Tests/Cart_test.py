...
class Cart_test(unittest.TestCase):
    ...
    def test1_add_product_to_the_cart_and_check_widget_details(self):
        ...
        self.assertEqual(self.header_page.get_product_in_cart_count(),1)
        self.header_page.hover_over_cart_widget()
        self.assertEqual(self.header_page.get_total_price_from_cart_widget(), Test_data.data['beanie_single_item_in_cart_price'])
        self.shop_page.click_hoodie_with_logo_page_link()
    ...
    def test2_add_multiple_the_same_products_to_the_cart_and_check_widget_details(self):
        ...
        self.assertEqual(self.header_page.get_product_in_cart_count(),3)
        self.header_page.hover_over_cart_widget()
        self.assertEqual(self.header_page.get_total_price_from_cart_widget(),Test_data.data['beanie_three_item_in_cart_price'])
    ...
    def test3_add_multiple_products_to_the_cart_and_check_widget_details(self):
        ...
        self.assertEqual(self.header_page.get_product_in_cart_count(),3)
        self.header_page.hover_over_cart_widget()
        self.assertEqual(self.header_page.get_total_price_from_cart_widget(),Test_data.data['beanie_belt_cap_items_in_cart_price'])
    ...
    def test4_add_multiple_products_to_the_cart_and_check_cart_page_details(self):
        ...
        self.shop_page.wait_for_products_to_be_loaded_to_cart_after_button_click()
        self.header_page.hover_over_cart_widget()
        self.header_page.click_cart_page_button_from_widget()
    ...
    def test5_add_multiple_products_to_the_cart_remove_one_product_from_the_cart_widget_and_check_widget_details(self):
        ...
        self.shop_page.wait_for_products_to_be_loaded_to_cart_after_button_click()
        self.header_page.hover_over_cart_widget()
        self.header_page.click_remove_cap_from_cart_in_widget()
        self.header_page.wait_for_cap_to_be_removed_from_widget()
        self.assertEqual(self.header_page.get_total_price_from_cart_widget(),Test_data.data['beanie_belt_items_in_cart_price'])
    ...
    def test8_add_multiple_products_to_the_cart_remove_all_product_from_the_cart_widget(self):
        ...
        self.header_page.hover_over_cart_widget()
        self.header_page.click_remove_cap_from_cart_in_widget()   
        self.header_page.click_remove_beanie_from_cart_in_widget()
        self.header_page.click_remove_belt_from_cart_in_widget()
        self.header_page.hover_over_cart_widget()
        self.assertTrue(self.header_page.assess_is_cart_empty())
    ...
    def test10_log_in_add_product_to_the_cart_and_check_cart_page_details(self):
        ...
        self.header_page.hover_over_cart_widget()
        self.header_page.click_cart_page_button_from_widget()
        self.assertEqual(self.cart_page.get_total_price(),Test_data.data['beanie_single_item_in_cart_price'])
        self.cart_page.clear_all_items_in_cart_in_cart_page()
    ...
    def test11_log_in_add_product_to_the_cart_log_out_log_in_and_check_is_product_still_in_cart(self):
        ...
        self.header_page.hover_over_cart_widget()
        self.assertEqual(self.header_page.get_total_price_from_cart_widget(),Test_data.data['beanie_single_item_in_cart_price'])
        self.header_page.clear_all_items_in_cart_in_cart_widget()
    ...
    def test12_add_multiple_products_to_the_cart_from_product_page(self):
        ...
        self.header_page.click_shop_button()
        self.shop_page.click_hoodie_with_logo_page_link()
        self.product_page.clear_quantity_iput()
        self.product_page.insert_text_into_quantity_iput(Test_data.data['hoodie_with_logo_new_quantity_for_product_page_test'])
        self.product_page.click_add_to_cart_button()
        self.product_page.wait_untill_cart_is_updated()
        self.header_page.hover_over_cart_widget()
        self.assertEqual(self.header_page.get_product_in_cart_count_product_page(),Test_data.data['hoodie_with_logo_new_quantity_for_product_page_test'])
        self.assertEqual(self.header_page.get_total_price_from_cart_widget(),Test_data.data['hoodie_with_logo_fiver_intems_in_cart_price'])
